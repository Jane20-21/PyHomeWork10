...
TOKEN = '5473119887:AAHt1kljasR5NBldSoXKFORuP7HlhiVMfek'
...
def info(update, context):
    update.message.reply_text(
        "Правила игры: Игрок вводит сколько конфет на кону, потом Игрок и Бот поочереди делают ход, за один ход можно взять не более 28 конфет. Побеждает Игрок, забравший последние конфеты.")
